...
class _SignupScreenState extends State<SignupScreen> {
  ...
  List<String> branches = ['Computer Science', 'Electronics', 'Mechanical', 'Civil', 'Electrical'];
          ...
          child: Column(
            children: [
              ...
              DropdownButtonFormField(
                ...
                decoration: InputDecoration(labelText: "Select Branch", border: OutlineInputBorder()),
              ...
              DropdownButtonFormField(
                value: selectedSem,
                decoration: InputDecoration(labelText: "Select Semester", border: OutlineInputBorder()),
